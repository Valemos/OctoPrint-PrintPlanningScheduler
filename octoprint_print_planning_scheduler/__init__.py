...
class Print_planning_schedulerPlugin(octoprint.plugin.SettingsPlugin,
    ...
    def get_update_information(self):
        ...
        return {
            "print_planning_scheduler": {
                "displayName": "Print_planning_scheduler Plugin",
...
__plugin_name__ = "Print_planning_scheduler Plugin"
...
def __plugin_load__():
    ...
    __plugin_implementation__ = Print_planning_schedulerPlugin()
